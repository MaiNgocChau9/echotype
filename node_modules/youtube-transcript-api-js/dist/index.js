...
exports.YouTubeTranscriptApiException = void 0; var _CouldNotRetrieveTranscript; exports.CouldNotRetrieveTranscript = void 0; exports.YouTubeDataUnparsable = void 0; exports.YouTubeRequestFailed = void 0; exports.VideoUnplayable = void 0; exports.VideoUnavailable = void 0; exports.InvalidVideoId = void 0; var _RequestBlocked; exports.RequestBlocked = void 0; exports.IpBlocked = void 0; exports.TranscriptsDisabled = void 0; exports.AgeRestricted = void 0; exports.NotTranslatable = void 0; exports.TranslationLanguageNotAvailable = void 0; exports.FailedToCreateConsentCookie = void 0; exports.NoTranscriptFound = void 0; exports.PoTokenRequired = void 0; exports.CookieError = void 0; exports.CookiePathInvalid = void 0; exports.CookieInvalid = void 0; exports.InvalidProxyUrl = void 0; exports.TranscriptParseError = void 0; exports.RateLimitExceeded = void 0; exports.NetworkError = void 0; exports.TimeoutError = void 0; exports.ConnectionError = void 0;
var init_errors = __esm({
  "youtube-transcript-api-js/errors/index.ts"() {
    exports.YouTubeTranscriptApiException = class extends Error {
      constructor(message) {
        super(message);
        this.name = "YouTubeTranscriptApiException";
      }
    };
    _CouldNotRetrieveTranscript = class _CouldNotRetrieveTranscript extends exports.YouTubeTranscriptApiException {
      constructor(videoId) {
        super("");
    ...
    exports.CouldNotRetrieveTranscript = _CouldNotRetrieveTranscript;
    exports.YouTubeDataUnparsable = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
    ...
    exports.YouTubeRequestFailed = class extends exports.CouldNotRetrieveTranscript {
    ...
    exports.VideoUnplayable = class extends exports.CouldNotRetrieveTranscript {
...
${subReasonsText}`;
    ...
    exports.VideoUnavailable = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
        return "The video is no longer available";
      }
    };
    exports.InvalidVideoId = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
    ...
    _RequestBlocked = class _RequestBlocked extends exports.CouldNotRetrieveTranscript {
      constructor(videoId) {
        super(videoId);
...
2. (NOT RECOMMENDED) If you authenticate your requests using cookies, you will be able to continue doing requests for a while. However, YouTube will eventually permanently ban the account that you have used to authenticate with! So only do this if you don't mind your account being banned!`;
    exports.RequestBlocked = _RequestBlocked;
    exports.IpBlocked = class extends exports.RequestBlocked {
      getCause() {
        return exports.RequestBlocked.BASE_CAUSE_MESSAGE + 'Ways to work around this are explained in the "Working around IP bans" section of the README (https://github.com/jdepoix/youtube-transcript-api?tab=readme-ov-file#working-around-ip-bans-requestblocked-or-ipblocked-exception).\n';
      }
    };
    exports.TranscriptsDisabled = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
        return "Subtitles are disabled for this video";
      }
    };
    exports.AgeRestricted = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
    ...
    exports.NotTranslatable = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
        return "The requested language is not translatable";
      }
    };
    exports.TranslationLanguageNotAvailable = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
        return "The requested translation language is not available";
      }
    };
    exports.FailedToCreateConsentCookie = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
        return "Failed to automatically give consent to saving cookies";
      }
    };
    exports.NoTranscriptFound = class extends exports.CouldNotRetrieveTranscript {
...
${this.transcriptData}`;
    ...
    exports.PoTokenRequired = class extends exports.CouldNotRetrieveTranscript {
      getCause() {
        return "The requested video cannot be retrieved without a PO Token. If this happens, please open a GitHub issue!";
      }
    };
    exports.CookieError = class extends exports.YouTubeTranscriptApiException {
      constructor(message) {
        super(message);
        this.name = "CookieError";
      }
    };
    exports.CookiePathInvalid = class extends exports.CookieError {
      constructor(cookiePath) {
        super(`Can't load the provided cookie file: ${cookiePath}`);
      }
    };
    exports.CookieInvalid = class extends exports.CookieError {
      constructor(cookiePath) {
        super(`The cookies provided are not valid (may have expired): ${cookiePath}`);
      }
    };
    exports.InvalidProxyUrl = class extends exports.YouTubeTranscriptApiException {
      constructor(url, reason) {
        super(`Invalid proxy URL "${url}": ${reason}`);
        this.name = "InvalidProxyUrl";
      }
    };
    exports.TranscriptParseError = class extends exports.YouTubeTranscriptApiException {
    ...
    exports.RateLimitExceeded = class extends exports.CouldNotRetrieveTranscript {
    ...
    exports.NetworkError = class extends exports.YouTubeTranscriptApiException {
    ...
    exports.TimeoutError = class extends exports.NetworkError {
    ...
    exports.ConnectionError = class extends exports.NetworkError {
  ...
  if (error instanceof axios.AxiosError) {
    if (error.response) {
      ...
      if (status === 429) {
        ...
        throw new exports.RateLimitExceeded(videoId, retryAfterSeconds);
      }
    }
    if (error.code) {
      if (error.code === "ECONNABORTED" || error.code === "ETIMEDOUT") {
        const timeout = error.config?.timeout || 0;
        throw new exports.TimeoutError(url, timeout);
      }
      if (error.code === "ECONNREFUSED" || error.code === "ENOTFOUND" || error.code === "ENETUNREACH") {
        throw new exports.ConnectionError(url, error.code);
      }
      throw new exports.NetworkError(`Request to ${url} failed: ${error.message}`, error.code);
    }
    throw new exports.NetworkError(`Request to ${url} failed: ${error.message}`);
  }
  throw error;
}
      ...
      async parse(rawData) {
        try {
          ...
          if (!xmlDoc || !("transcript" in xmlDoc)) {
            throw new exports.TranscriptParseError(
          ...
          if (xmlDoc.transcript && xmlDoc.transcript.text) {
            for (const element of xmlDoc.transcript.text) {
              ...
              if (textContent !== void 0 && textContent !== null) {
                ...
                snippets.push(new exports.FetchedTranscriptSnippet(text, start, duration));
              }
            }
          }
          return snippets;
        } catch (error) {
          if (error instanceof exports.TranscriptParseError) throw error;
          throw new exports.TranscriptParseError(
...
exports.FetchedTranscriptSnippet = void 0; exports.FetchedTranscript = void 0; exports.TranslationLanguage = void 0; exports.Transcript = void 0; exports.TranscriptList = void 0;
var init_models = __esm({
  "youtube-transcript-api-js/transcripts/models.ts"() {
    init_errors();
    init_network_errors();
    exports.FetchedTranscriptSnippet = class {
    ...
    exports.FetchedTranscript = class {
    ...
    exports.TranslationLanguage = class {
      constructor(language, languageCode) {
        this.language = language;
        this.languageCode = languageCode;
      }
    };
    exports.Transcript = class _Transcript {
      ...
      async fetch(preserveFormatting = false) {
        if (this.url.includes("&exp=xpe")) {
          throw new exports.PoTokenRequired(this.videoId);
        }
        let response;
        try {
        ...
        return new exports.FetchedTranscript(
          snippets,
          this.videoId,
          this.language,
          this.languageCode,
      ...
      translate(languageCode) {
        if (!this.isTranslatable) {
          throw new exports.NotTranslatable(this.videoId);
        }
        if (!this.translationLanguagesDict.has(languageCode)) {
          throw new exports.TranslationLanguageNotAvailable(this.videoId);
        }
    ...
    exports.TranscriptList = class {
      ...
      findTranscriptInSources(languageCodes, transcriptSources) {
        ...
        throw new exports.NoTranscriptFound(this.videoId, languageCodes, this.toString());
      }
      /**
...
function isRetryableError(error) {
  return error instanceof exports.RateLimitExceeded || error instanceof exports.NetworkError || // also catches TimeoutError, ConnectionError (subclasses)
  error instanceof exports.RequestBlocked;
}
...
var TranscriptListFetcher = class {
    ...
    for (let attempt = 0; attempt < maxAttempts; attempt++) {
      try {
        ...
        if (!isRetryableError(error) || attempt === maxAttempts - 1) {
          if (error instanceof exports.RequestBlocked) {
            throw error.withProxyConfig(this.proxyConfig);
          }
          throw error;
        }
        const retryAfter = error instanceof exports.RateLimitExceeded ? error.retryAfter : void 0;
  ...
  extractInnertubeApiKey(html, videoId) {
    ...
    if (html.includes('class="g-recaptcha"')) {
      throw new exports.IpBlocked(videoId);
    }
    throw new exports.YouTubeDataUnparsable(videoId);
  }
  /**
  ...
  extractCaptionsJson(innertubeData, videoId) {
    ...
    if (!captionsJson || !captionsJson.captionTracks) {
      throw new exports.TranscriptsDisabled(videoId);
    }
    ...
    if (playabilityStatus && playabilityStatus !== PLAYABILITY_STATUS.OK) {
      ...
      if (playabilityStatus === PLAYABILITY_STATUS.LOGIN_REQUIRED) {
        if (reason === PLAYABILITY_FAILED_REASON.BOT_DETECTED) {
          throw new exports.RequestBlocked(videoId);
        }
        if (reason === PLAYABILITY_FAILED_REASON.AGE_RESTRICTED) {
          throw new exports.AgeRestricted(videoId);
        }
      }
      if (playabilityStatus === PLAYABILITY_STATUS.ERROR && reason === PLAYABILITY_FAILED_REASON.VIDEO_UNAVAILABLE) {
        if (videoId.startsWith("http://") || videoId.startsWith("https://")) {
          throw new exports.InvalidVideoId(videoId);
        }
        throw new exports.VideoUnavailable(videoId);
      }
      ...
      throw new exports.VideoUnplayable(videoId, reason ?? null, subreasonTexts);
    }
  }
  /**
  ...
  createConsentCookie(html, videoId) {
    ...
    if (!match) {
      throw new exports.FailedToCreateConsentCookie(videoId);
    }
  ...
  buildTranscriptList(videoId, captionsJson, videoDetails) {
    const translationLanguages = (captionsJson.translationLanguages || []).map(
      (tl) => new exports.TranslationLanguage(
    ...
    for (const caption of captionsJson.captionTracks || []) {
      ...
      const transcript = new exports.Transcript(
        this.httpClient,
        videoId,
    ...
    return new exports.TranscriptList(
      videoId,
...
function parseJsonCookies(content) {
  ...
  try {
    ...
    throw new exports.CookieInvalid("cookie file");
  }
...
function loadCookiesFromFile(cookiePath) {
  let content;
  try {
    content = fs__namespace.readFileSync(cookiePath, "utf-8");
  } catch (err) {
    if (err instanceof Error && "code" in err && err.code === "ENOENT") {
      throw new exports.CookiePathInvalid(cookiePath);
    }
    throw err;
  }
  const ext = path__namespace.extname(cookiePath).toLowerCase();
  ...
  if (youtubeCookies.length === 0) {
    throw new exports.CookieInvalid(cookiePath);
  }
...
var YouTubeTranscriptApi = class {
  ...
  extractProxyHost(url) {
    try {
      ...
      throw new exports.InvalidProxyUrl(url, "Unable to parse hostname from URL");
    }
  }
  /**
  ...
  extractProxyPort(url) {
    try {
      ...
      throw new exports.InvalidProxyUrl(url, "Unable to parse port from URL");
    }
  }
  /**
  ...
  extractProxyAuth(url) {
    try {
      ...
      throw new exports.InvalidProxyUrl(url, "Unable to parse authentication from URL");
    }
  }
  /**
  ...
  validateVideoId(videoId) {
    if (!videoId || typeof videoId !== "string") {
      throw new exports.InvalidVideoId(String(videoId));
    }
    const trimmed = videoId.trim();
    if (trimmed === "") {
      throw new exports.InvalidVideoId("");
    }
    const lowerCased = trimmed.toLowerCase();
    if (lowerCased.includes("youtube.com") || lowerCased.includes("youtu.be")) {
      throw new exports.InvalidVideoId(trimmed);
    }
    return trimmed;
  }
  /**
...
var EnhancedYouTubeTranscriptApi = class {
  ...
  async getVideoMetadata(videoId) {
    ...
    if (!metadata) {
      throw new exports.YouTubeTranscriptApiException(`Could not retrieve metadata for video: ${videoId}`);
    }
    return {
...
exports.TimestampedTextFormatter = TimestampedTextFormatter;
